...
import { getChains, getTokens } from "../../apis/precisionFunding"
...
function MintNFTModal({ close, contractAddresses, landscape }) {
  ...
  const { type: walletType, address: walletAddress } = useUnifiedWallet()
  ...
  const onSubmit = async (data) => {
    ...
    if (walletType === "solana" && chainName === "solana") {
    ...
    } else if (walletType === "evm" && chainName !== "solana") {
      try {
        startLoading()
      ...
      toast.error("Please connect the correct wallet for the selected chain.")
      return
    }
  }
